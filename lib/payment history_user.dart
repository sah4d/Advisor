...
class payhisU extends StatefulWidget {
  const payhisU({super.key});

  @override
  State<payhisU> createState() => _payhisUState();
}

class _payhisUState extends State<payhisU> {
  _payhisUState() {
    prefs();
    fetchAdsData();
  }
  ...
  Future<void> fetchAdsData() async {
    ...
    QuerySnapshot querySnapshot = await adsRef.where("purchased by", isEqualTo: pref.getString("lid11").toString()).get();
