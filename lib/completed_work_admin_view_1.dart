...
class BookedAdsW1 extends StatefulWidget {
  const BookedAdsW1({super.key});

  @override
  State<BookedAdsW1> createState() => _BookedAdsW1State();
}

class _BookedAdsW1State extends State<BookedAdsW1> {
  _BookedAdsW1State() {
    prefs();
    fetchAdsData();
  }
  ...
  Future<void> fetchAdsData() async {
    ...
    QuerySnapshot querySnapshot = await adsRef.where("worker phone", isEqualTo: pref.getString("worker11").toString()).get();
