...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> editfire() async {
    CollectionReference firedb = FirebaseFirestore.instance.collection("logindetailsuser");
    QuerySnapshot qs= await firedb.where("phone",isEqualTo: ph).where("password",isEqualTo: pass).get();
    final doc2=qs.docs;
    String Id=doc2.first.id;
    firedb.doc(Id).update({"phone":ph,"password":_confirmPasswordController.text,"type":"User"});
  }
