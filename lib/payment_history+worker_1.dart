...
class payhisW1 extends StatefulWidget {
  const payhisW1({super.key});

  @override
  State<payhisW1> createState() => _payhisW1State();
}

class _payhisW1State extends State<payhisW1> {
  _payhisW1State() {
    prefs();
    fetchAdsData();
  }
  ...
  Future<void> prefs() async {
    ...
    ph=prefs.getString("worker11").toString();
    print(ph);
  }
  ...
  Future<void> fetchAdsData() async {
    ...
    QuerySnapshot querySnapshot = await adsRef.where("paid to", isEqualTo: pref.getString("worker11").toString()).get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(flexibleSpace: Container(decoration: BoxDecoration(
        ...
        title: Text("Payment History", style: GoogleFonts.montserrat(fontSize: 18, fontWeight: FontWeight.bold,color: Colors.black87)),
                    ...
                    children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text(paydate_[index],style: GoogleFonts.montserrat(),),
                        ],
                      )),
