...
class payhisU1 extends StatefulWidget {
  const payhisU1({super.key});

  @override
  State<payhisU1> createState() => _payhisU1State();
}

class _payhisU1State extends State<payhisU1> {
  _payhisU1State() {
    prefs();
    fetchAdsData();
  }
  ...
  Future<void> fetchAdsData() async {
    ...
    QuerySnapshot querySnapshot = await adsRef.where("purchased by", isEqualTo: pref.getString("user11").toString()).get();
